...
uint32_t pci_config_read(uint8_t bus, uint8_t device, uint8_t func,
                         uint8_t offset);
void pci_config_write(uint8_t bus, uint8_t device, uint8_t func, uint8_t offset,
                      uint32_t value);
...
void pci_enumerate(void (*callback)(int bdf, uint16_t vendor,
                                    uint16_t device_id));
void pci_scan_and_register(void);

/* Architectural implementations */
uint32_t arch_pci_config_read(uint8_t bus, uint8_t device, uint8_t func,
                              uint8_t offset);
void arch_pci_config_write(uint8_t bus, uint8_t device, uint8_t func,
